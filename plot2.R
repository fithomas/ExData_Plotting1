# ****************************************************************************************************************
# Filename:       plot2.R 
# Description:    This program dowloads the data and creates the second plot as a png file.
# ****************************************************************************************************************
...
# ****************************************************************************************************************
# 4) Prepare the second plot, which should be a timesieries plot of global active power 
# ****************************************************************************************************************

with(data2,plot(DateTime,Global_active_power,type="n", main="",ylab="Global Active Power (kilowatts)",xlab=""))
with(data2,lines(DateTime,Global_active_power,type="l"))


# ****************************************************************************************************************
# 5) Export the second plot 
# ****************************************************************************************************************
